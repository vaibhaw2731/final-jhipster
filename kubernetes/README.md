...
```
$ docker image tag ui shagunbandi/ui
$ docker push shagunbandi/ui
$ docker image tag organization shagunbandi/organization
$ docker push shagunbandi/organization
$ docker image tag leave shagunbandi/leave
$ docker push shagunbandi/leave
$ docker image tag meeting shagunbandi/meeting
$ docker push shagunbandi/meeting
$ docker image tag notification shagunbandi/notification
$ docker push shagunbandi/notification
```
