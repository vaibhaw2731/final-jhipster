...
/**
 * REST controller for managing {@link com.myapp.yourapp.meeting.domain.MeetingRoom}.
 */
@RestController
@RequestMapping("/api")
public class MeetingRoomResource {
    ...
    public ResponseEntity<List<MeetingRoom>> getAllMeetingRooms(Pageable pageable) {
