package com.myapp.yourapp.meeting.config;
...
@Configuration
@EnableMongoRepositories("com.myapp.yourapp.meeting.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.myapp.yourapp.meeting.config.dbmigrations");
