package com.myapp.yourapp.meeting.web.rest;

import com.myapp.yourapp.meeting.domain.Meeting;
import com.myapp.yourapp.meeting.service.MeetingService;
import com.myapp.yourapp.meeting.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.myapp.yourapp.meeting.domain.Meeting}.
 */
@RestController
@RequestMapping("/api")
public class MeetingResource {
     ...
     */
    @GetMapping("/meetings")
    public ResponseEntity<List<Meeting>> getAllMeetings(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
