package com.myapp.yourapp.organization.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("organization");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("organization");
        ...
        config.getMapConfigs().put("com.myapp.yourapp.organization.domain.*", initializeDomainMapConfig(jHipsterProperties));
