    ...
    return (
      <div>
        <h2 id="participant-heading">
          <Translate contentKey="uiApp.meetingParticipant.home.title">Participants</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="uiApp.meetingParticipant.home.createLabel">Create a new Participant</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {participantList && participantList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('email')}>
                    <Translate contentKey="uiApp.meetingParticipant.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="uiApp.meetingParticipant.home.notFound">No Participants found</Translate>
            </div>
          )}
        </div>
