...
export class EmployeeLeaveDeleteDialog extends React.Component<IEmployeeLeaveDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.employeeLeaveEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-employeeLeave" color="danger" onClick={this.confirmDelete}>
