  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="uiApp.notificationNotification.delete.question">
          <Translate contentKey="uiApp.notificationNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
