  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="uiApp.organizationEmployee.delete.question">
          <Translate contentKey="uiApp.organizationEmployee.delete.question" interpolate={{ id: employeeEntity.id }}>
