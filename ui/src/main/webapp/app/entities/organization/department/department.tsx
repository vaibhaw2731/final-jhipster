    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="uiApp.organizationDepartment.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="uiApp.organizationDepartment.home.createLabel">Create a new Department</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {departmentList && departmentList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('code')}>
                    <Translate contentKey="uiApp.organizationDepartment.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('name')}>
                    <Translate contentKey="uiApp.organizationDepartment.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="uiApp.organizationDepartment.home.notFound">No Departments found</Translate>
            </div>
          )}
        </div>
