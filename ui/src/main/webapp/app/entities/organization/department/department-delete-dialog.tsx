  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="uiApp.organizationDepartment.delete.question">
          <Translate contentKey="uiApp.organizationDepartment.delete.question" interpolate={{ id: departmentEntity.id }}>
