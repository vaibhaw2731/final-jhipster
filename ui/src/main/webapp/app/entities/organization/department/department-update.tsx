    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="uiApp.organizationDepartment.home.createOrEditLabel">
              <Translate contentKey="uiApp.organizationDepartment.home.createOrEditLabel">Create or edit a Department</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
