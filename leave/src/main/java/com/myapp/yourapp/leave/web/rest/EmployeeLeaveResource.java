...
import com.myapp.yourapp.leave.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.myapp.yourapp.leave.domain.EmployeeLeave}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeLeaveResource {
    ...
    public ResponseEntity<List<EmployeeLeave>> getAllEmployeeLeaves(Pageable pageable) {
