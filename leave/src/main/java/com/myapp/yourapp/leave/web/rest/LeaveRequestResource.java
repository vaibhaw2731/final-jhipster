...
/**
 * REST controller for managing {@link com.myapp.yourapp.leave.domain.LeaveRequest}.
 */
@RestController
@RequestMapping("/api")
public class LeaveRequestResource {
    ...
    public ResponseEntity<List<LeaveRequest>> getAllLeaveRequests(Pageable pageable) {
